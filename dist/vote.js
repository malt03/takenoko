...
function default_1() {
    return __awaiter(this, void 0, void 0, function () {
        var browser, page, response, responseText, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, page.goto('https://www.meiji.co.jp/sweets/chocolate/kinotake/cmp/2019senkyo/')];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, page.waitForSelector('.loader', { hidden: true })];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, page.click('.takenoko > .web')];
                case 6:
                    _a.sent();
